            ...
            <div class="row g-4 py-5 row-cols-1 justify-content-center">
                <div class="feature col-lg-4">
                    <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
                        <svg class="m-1" width="1em" height="1em" viewBox="0 0 24 24" fill="none"
                    ...
                    <p>Steady Plan centralizes your team’s projects in a unified environment, ensuring everyone stays
                        informed and aligned. By bringing communication, task updates, and project details together,
                        teams
                        reduce friction and maintain consistent momentum.</p>
                </div>
                <div class="feature col-lg-4">
                    <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
                        <svg class="m-1" width="1em" height="1em" viewBox="0 0 24 24" fill="none"
                    ...
                    <p>Tasks are organized through an intuitive Kanban board that makes project progress visible at a
                        glance. This structured workflow supports faster decision-making, improves accountability, and
                        helps
                        teams prioritize the work that matters most.</p>
                </div>
                <div class="feature col-lg-4">
                    <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
                        <svg class="m-1" width="1em" height="1em" viewBox="0 0 24 24" fill="none"
                    ...
                    <p>Every action, from task creation to status updates, is captured in a clear project activity feed.
                        This transparency strengthens team coordination, minimizes miscommunication, and supports
                        reliable,
                        audit-ready project oversight.</p>
                </div>
            </div>
        </div>
    </div>
