...
class ActivityRepo extends BaseRepo {
    public static function addActivity($actionType, $projectID, $userID = null, $taskID = null, $columnID = null) {
    ...
    public static function getProjectActivity($projectID, $userID) {
