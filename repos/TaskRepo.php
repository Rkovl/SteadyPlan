...
class TaskRepo extends BaseRepo {
    ...
    public static function getTasksFromColumn($columnID) {
    ...
    public static function getTasksFromProject($projectID) {
    ...
    public static function createTask($projectID, $columnID, $name, $description = null) {
    ...
    public static function changeColumn($columnID, $taskID) {
    ...
    public static function changeName($name, $taskID, $projectID, $columnID) {
    ...
    public static function changeDescription($description, $taskID, $projectID, $columnID) {
